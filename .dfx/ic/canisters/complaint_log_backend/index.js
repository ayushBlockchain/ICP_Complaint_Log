...
import { idlFactory } from './complaint_log_backend.did.js';
export { idlFactory } from './complaint_log_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMPLAINT_LOG_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./complaint_log_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the complaint_log_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./complaint_log_backend.did.js")._SERVICE>}
 */
export const complaint_log_backend = createActor(canisterId);
